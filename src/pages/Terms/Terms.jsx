    ...
    <div className='Terms-Conditions' id='pdf'>
        ...
        <div className="body-content">
            ...
            <div className="col">
                ...
                <p>9.1 Se doter d’une connexion internet, à ses frais, nécessaire à l’exploitation de la solution. Le prestataire décline toute responsabilité en cas de déconnexion ou autres anomalies constatées tout au long de la durée de la convention. </p>
                <p>9.2 Ne pas apporter de modifications ou d’adjonctions de quelque nature que ce soit au système de transmission et de Géolocalisation.</p>
                <p>9.3 Signaler au service après-vente toute défaillance, déconnexion ou défectuosité du matériel mis à sa disposition : </p>
                <p>Par email à l’adresse suivante : sales@traxy.org support@traxy.dz </p>
                <p> 9.4- Assurer le paiement de la prestation tout au long de la durée du contrat, même en cas de changement de véhicule (accident, panne, vente, location, véhicules non-disponible, prêt…). Pour toute autre demande d’ajouts de fonctionnalités, le prestataire communiquera un nouveau devis. </p>
                <p>9.5- Le client est dans l’obligation de notifier par écrit au prestataire tout changement sur l’un des documents contractuels : la raison sociale, RIB, changement d’adresse, numéro de téléphone de la personne chargée du système de géolocalisation, mail ou bien toute modification relative au véhicule et à son immatriculation. En cas de vente d’un véhicule équipé d’un boîtier GPS, le client doit saisir par écrit le prestataire pour que celui-ci effectue la désinstallation du boîtier. Dans le cas où le nouvel acquéreur souhaiterait conserver le boîtier, il est dans l’obligation d’établir un nouveau contrat avec le prestataire et fournir systématiquement les documents contractuels cités dans l’article 3. En cas de détérioration du boîtier ou incendie, le client doit transmettre le rapport de l’incident au prestataire. 9.6- Ne pas cédé ce contrat, les boîtiers et les accès à la solution à une tierce personne, même en cas de vente de véhicule, sans un accord écrit de la part du prestataire.</p>
                <p className="bold">
                10- Respect Planning :
                </p>
                <p>
                ...
                <p>10-2-1 : Désinstallation définitive La désinstallation définitive est considérée comme une résiliation. (Même conditions résiliation s’appliquent voir article 12) </p>
                <p>10-2-2 Désinstallation Temporaire : La durée tolérée de la désinstallation temporaire est maximum de deux mois. Passé cette durée, le client sera dans l’obligation de mettre à la disposition d’EURL TRAXY un chèque à hauteur de deux mois d’abonnement. </p>
        ...
        <div className="down-content">
            <div className="col">
                ...
                <p>N° de compte : EURL TRAXY </p>
                <p>Banque : TRUST </p>
                <p>Agence : BATNA</p>
                <p>Adresse : BATNA, ALGERIE</p>
                <p>Relevé d’identité bancaire : 02900603220003917836</p>
