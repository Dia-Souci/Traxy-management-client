...
function VehiculeDash() {
    ...
    useEffect(()=>{
        const fetchVehiculeData = async () =>{
            const response = await fetch(`https://traxy-management-api.vercel.app/api/customervehicules/getallvehicules`,{
                headers:{
    ...
    <div className='Dashboard-vehicule-main-container'>
        <nav className='Navbar-traxy-container'>
            ...
            <ul className='links-list'>
                <Link to='/vehicule-dashboard' style={{ textDecoration: 'none' }}>
                    <li className={`links-item selected`}>Vehicules</li>
                </Link>
        ...
        <div className="vehiculeDash-container">
            <div className="vehiculeDash-headSection">
                <h1 className='vehiculeDash-main-title'>Vehicules Dashboard</h1>
                <div className="searchAndbtn-container">
                    <Link to='/Createvehicule' aria-disabled style={{ textDecoration: 'none' }}>
